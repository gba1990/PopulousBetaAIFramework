...
table.insert(blueAI:getModule(AI_MODULE_TREE_MANAGER_ID).treeSearchLocations, {centre = util.create_Coord2D(towerX, towerY), radius = 10000})
...
blueAI:getModule(AI_MODULE_BUILDING_PLACER_ID):addBuildPlace(towerPlace)
blueAI:getModule(AI_MODULE_BUILDING_PLACER_ID):addBuildPlace(hut1)
blueAI:getModule(AI_MODULE_BUILDING_PLACER_ID):addBuildPlace(hut2)
blueAI:getModule(AI_MODULE_BUILDING_PLACER_ID):addBuildPlace(hut3)